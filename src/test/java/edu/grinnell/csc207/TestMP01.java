...
public class TestMP01 {
  ...
  public void isValidStringTest(){
    assertEquals(false, CipherUtils.isValidString("hi world"), "string with space");
    assertEquals(true, CipherUtils.isValidString("helloworld"), "valid");
    assertEquals(false, CipherUtils.isValidString("1234"), "numbers");
    assertEquals(false, CipherUtils.isValidString("CAPITALS"), "capitals");
  }
   ...
   */
  @Test
  public void cipherInvalidString2() {
    cipherTest("M", new String[] { "-encode", "-vigenere", "hi world", "a" },
        null);
  } // cipherInvalidString()
